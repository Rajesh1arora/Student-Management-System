...
#top frames
Label(root,text="Email: ra4492607@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Srch.place(x=1060,y=75)
imageicon4=PhotoImage(file="layer.png")
